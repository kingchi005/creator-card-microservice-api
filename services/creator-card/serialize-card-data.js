 ...
 * @param {boolean} [includeTimestamps] - Whether to include (created, updated, deleted) in the DTO (default: false)
 * @returns {Object} Clean, serialized object
 */
function serializeCreatorCard(document, includeTimestamps = false) {
